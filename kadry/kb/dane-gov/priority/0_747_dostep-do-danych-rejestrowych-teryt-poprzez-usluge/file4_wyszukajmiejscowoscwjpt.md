---
dataset_id: 747
file: WyszukajMiejscowoscWJPT.pdf
file_size_mb: 0.26
...
Schema XML definiujący zwracany przez metodę WyszukajMiejscowoscWJPT  
...
ref="q1:WyszukajMiejscowoscWJPTResponse" /> 
            </xs:sequence> 
          </xs:complexType> 
        </xs:element> 
      </xs:sequence> 
...
xmlns:xs="http://www.w3.org/2001/XMLSchema"> 
  ...
  <xs:element name="WyszukajMiejscowoscWJPTResponse"> 
    <xs:complexType> 
      <xs:sequence> 
        <xs:element name="WyszukajMiejscowoscWJPTResult"> 
          <xs:complexType> 
            <xs:sequence> 
              <xs:element 
...
<s:Envelope xmlns:s="http://schemas.xmlsoap.org/soap/envelope/"> 
  <s:Header /> 
  <s:Body> 
    <WyszukajMiejscowoscWJPTResponse xmlns="http://tempuri.org/"> 
      <WyszukajMiejscowoscWJPTResult 
xmlns:a="http://schemas.datacontract.org/2004/07/TerytUslugaWs1" 
xmlns:i="http://www.w3.org/2001/XMLSchema-instance"> 
        <a:Miejscowosc> 
          <a:GmiRodzaj>5</a:GmiRodzaj> 
          <a:GmiSymbol>1020045</a:GmiSymbol> 
          <a:Gmina>Aleksandrów Łódzki</a:Gmina> 
          <a:Nazwa>Rąbień AB</a:Nazwa> 
          <a:PowSymbol>1020</a:PowSymbol> 
          <a:Powiat>zgierski</a:Powiat> 
          <a:Symbol>0412926</a:Symbol> 
          <a:WojSymbol>10</a:WojSymbol> 
          <a:Wojewodztwo>ŁÓDZKIE</a:Wojewodztwo> 
        </a:Miejscowosc> 
      </WyszukajMiejscowoscWJPTResult> 
    </WyszukajMiejscowoscWJPTResponse> 
  </s:Body> 
</s:Envelope> 

---
_Plik źródłowy: `data/raw/747/WyszukajMiejscowoscWJPT.pdf` (0.26 MB) · Pobrane z https://api.stat.gov.pl/_