...
Schema XML definiujący zwracany przez metodę WyszukajMiejscowosc  
...
ref="q1:WyszukajMiejscowoscResponse" /> 
            </xs:sequence> 
          </xs:complexType> 
        </xs:element> 
      </xs:sequence> 
...
xmlns:xs="http://www.w3.org/2001/XMLSchema"> 
  ...
  <xs:element name="WyszukajMiejscowoscResponse"> 
    <xs:complexType> 
      <xs:sequence> 
        <xs:element name="WyszukajMiejscowoscResult"> 
          <xs:complexType> 
            <xs:sequence> 
              <xs:element 
...
<s:Envelope xmlns:s="http://schemas.xmlsoap.org/soap/envelope/"> 
  <s:Header /> 
  <s:Body> 
    <WyszukajMiejscowoscResponse xmlns="http://tempuri.org/"> 
      <WyszukajMiejscowoscResult 
xmlns:a="http://schemas.datacontract.org/2004/07/TerytUslugaWs1" 
xmlns:i="http://www.w3.org/2001/XMLSchema-instance"> 
        <a:Miejscowosc> 
          <a:GmiRodzaj>1</a:GmiRodzaj> 
          <a:GmiSymbol>1001011</a:GmiSymbol> 
          <a:Gmina>Bełchatów</a:Gmina> 
          <a:Nazwa>Bełchatówek</a:Nazwa> 
          <a:PowSymbol>1001</a:PowSymbol> 
          <a:Powiat>bełchatowski</a:Powiat> 
          <a:Symbol>0967653</a:Symbol> 
...
---
_Plik źródłowy: `data/raw/747/WyszukajMiejscowosc.pdf` (0.26 MB) · Pobrane z https://api.stat.gov.pl/_